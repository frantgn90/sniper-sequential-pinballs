...
#define SIM_CMD_CHECKPOINT_IN   15
#define SIM_CMD_CHECKPOINT_OUT  16
...
#define SimCheckpointIn()         SimMagic0(SIM_CMD_CHECKPOINT_IN)
#define SimCheckpointOut()	  SimMagic0(SIM_CMD_CHECKPOINT_OUT)
