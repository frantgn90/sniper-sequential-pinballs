...
namespace Sift
{
   ...
   class Reader
   {
      ...
      typedef bool (*HandleCheckpoint)(void* arg);
      ...
      public:
         ...
         void setHandleCheckpoint(HandleCheckpoint func, void* arg = NULL) { assert(func); handleCheckpoint = func; handleCheckpointArg = arg; }
